...
public class BagnoEntrata extends AppCompatActivity {
    ImageView imageView;
    Button btnLuce23, btnLuce24, btnLuce25, btnTapp10;
    ...
    List<List<Integer>> dmtStanza = Arrays.asList(Arrays.asList(0, 23),
            Arrays.asList(0, 24),
            Arrays.asList(0, 25),
            Arrays.asList(1, 10));
    ...
    public void dialogTapp (final String a){
        final Dialog dialog_write = new Dialog(BagnoEntrata.this, R.style.AppAlert);
        ...
        btnokdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (edtvalue_write.getText().toString().length() == 0) {
                    Toast.makeText(BagnoEntrata.this, R.string.InserisciValoriValidi, Toast.LENGTH_SHORT).show();
                }
                else{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bagno_entrata);

        session_position = getIntent().getIntExtra("sessionPosition", -1);
        if (session_position < 0) {
            Toast.makeText(BagnoEntrata.this, R.string.Errore, Toast.LENGTH_SHORT).show();
            finish();
        }

        imageView = findViewById(R.id.imageStanza);

        btnLuce23 = findViewById(R.id.btnLuce23);
        btnLuce24 = findViewById(R.id.btnLuce24);
        btnLuce25 = findViewById(R.id.btnLuce25);
        btnTapp10 = findViewById(R.id.btnTapp10);
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.btnLuce23:
                        changeState(btnLuce23.getText().toString(), "23");
                        break;
                    case R.id.btnLuce24:
                        changeState(btnLuce24.getText().toString(), "24");
                        break;
                    case R.id.btnLuce25:
                        changeState(btnLuce25.getText().toString(), "25");
                        break;
                    case R.id.btnTapp10:
                        dialogTapp("10");
                        break;
        ...
        btnLuce23.setOnClickListener(listener);
        btnLuce24.setOnClickListener(listener);
        btnLuce25.setOnClickListener(listener);
        btnTapp10.setOnClickListener(listener);
    }
                ...
                switch (Step) {
                    ...
                    case 3:
                        if (Counter < Dim-1)
                            ...
                            Counter = 0;
                            btnLuce23.setText(txtButton.get(0));
                            btnLuce24.setText(txtButton.get(1));
                            btnLuce25.setText(txtButton.get(2));
                            btnTapp10.setText(txtButton.get(3));
                        }
                        Step = 0;
                        break;
                }
