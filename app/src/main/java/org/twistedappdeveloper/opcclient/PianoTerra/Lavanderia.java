...
public class Lavanderia extends AppCompatActivity {
    ImageView imageView;
    Button btnLuce29, btnLuce30, btnLuce37, btnTapp12;
    ...
    List<List<Integer>> dmtStanza = Arrays.asList(Arrays.asList(0, 29),
            Arrays.asList(0, 30),
            Arrays.asList(0, 37),
            Arrays.asList(1, 12));
    ...
    public void dialogTapp (final String a){
        final Dialog dialog_write = new Dialog(Lavanderia.this, R.style.AppAlert);
        ...
        btnokdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (edtvalue_write.getText().toString().length() == 0) {
                    Toast.makeText(Lavanderia.this, R.string.InserisciValoriValidi, Toast.LENGTH_SHORT).show();
                }
                else{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session_position < 0) {
            Toast.makeText(Lavanderia.this, R.string.Errore, Toast.LENGTH_SHORT).show();
            finish();
        }

        imageView = findViewById(R.id.imageStanza);

        btnLuce29 = findViewById(R.id.btnLuce29);
        btnLuce30 = findViewById(R.id.btnLuce30);
        btnLuce37 = findViewById(R.id.btnLuce37);
        btnTapp12 = findViewById(R.id.btnTapp12);
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.btnLuce29:
                        changeState(btnLuce29.getText().toString(), "29");
                        break;
                    case R.id.btnLuce30:
                        changeState(btnLuce30.getText().toString(), "30");
                        break;
                    case R.id.btnLuce37:
                        changeState(btnLuce37.getText().toString(), "37");
                        break;
                    case R.id.btnTapp12:
                        dialogTapp("12");
                        break;
        ...
        btnLuce29.setOnClickListener(listener);
        btnLuce30.setOnClickListener(listener);
        btnLuce37.setOnClickListener(listener);
        btnTapp12.setOnClickListener(listener);
    }
                ...
                switch (Step) {
                    ...
                    case 3:
                        if (Counter < Dim-1)
                            ...
                            Counter = 0;
                            btnLuce29.setText(txtButton.get(0));
                            btnLuce30.setText(txtButton.get(1));
                            btnLuce37.setText(txtButton.get(2));
                            btnTapp12.setText(txtButton.get(3));
                        }
                        Step = 0;
                        break;
                }
