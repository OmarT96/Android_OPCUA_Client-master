...
public class ScaleCorridoio extends AppCompatActivity {
    ImageView imageView;
    Button btnLuce11, btnLuce12, btnTapp5, btnTapp6;
    ...
    List<List<Integer>> dmtStanza = Arrays.asList(Arrays.asList(0, 11),
            Arrays.asList(0, 12),
            Arrays.asList(1, 5),
            Arrays.asList(1, 6));
    ...
    public void dialogTapp (final String a){
        final Dialog dialog_write = new Dialog(ScaleCorridoio.this, R.style.AppAlert);
        ...
        btnokdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (edtvalue_write.getText().toString().length() == 0) {
                    Toast.makeText(ScaleCorridoio.this, R.string.InserisciValoriValidi, Toast.LENGTH_SHORT).show();
                }
                else{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scale_corridoio);

        session_position = getIntent().getIntExtra("sessionPosition", -1);
        if (session_position < 0) {
            Toast.makeText(ScaleCorridoio.this, R.string.Errore, Toast.LENGTH_SHORT).show();
            finish();
        }

        imageView = findViewById(R.id.imageSalone);

        btnLuce11 = findViewById(R.id.btnLuce11);
        btnLuce12 = findViewById(R.id.btnLuce12);
        btnTapp5 = findViewById(R.id.btnTapp5);
        btnTapp6 = findViewById(R.id.btnTapp6);
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.btnLuce11:
                        changeState(btnLuce11.getText().toString(), "11");
                        break;
                    case R.id.btnLuce12:
        ...
        btnLuce11.setOnClickListener(listener);
        btnLuce12.setOnClickListener(listener);
        btnTapp5.setOnClickListener(listener);
        btnTapp6.setOnClickListener(listener);
    }
                ...
                switch (Step) {
                    ...
                    case 3:
                        if (Counter < Dim-1)
                            ...
                            Counter = 0;
                            btnLuce11.setText(txtButton.get(0));
                            btnLuce12.setText(txtButton.get(1));
                            btnTapp5.setText(txtButton.get(2));
                            btnTapp6.setText(txtButton.get(3));
                        }
                        Step = 0;
                        break;
                }
