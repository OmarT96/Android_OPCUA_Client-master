...
public class Studio extends AppCompatActivity {
    ImageView imageView;
    Button btnLuce13, btnLuce14, btnLuce15, btnTapp7, btnTapp8;
    ...
    List<List<Integer>> dmtStanza = Arrays.asList(Arrays.asList(0, 13),
            Arrays.asList(0, 14),
            Arrays.asList(0, 15),
            Arrays.asList(1, 7),
            Arrays.asList(1, 8));
    ...
    public void dialogTapp (final String a){
        final Dialog dialog_write = new Dialog(Studio.this, R.style.AppAlert);
        ...
        btnokdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (edtvalue_write.getText().toString().length() == 0) {
                    Toast.makeText(Studio.this, R.string.InserisciValoriValidi, Toast.LENGTH_SHORT).show();
                }
                else{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session_position < 0) {
            Toast.makeText(Studio.this, R.string.Errore, Toast.LENGTH_SHORT).show();
            finish();
        }

        imageView = findViewById(R.id.imageSalone);

        btnLuce13 = findViewById(R.id.btnLuce13);
        btnLuce14 = findViewById(R.id.btnLuce14);
        btnLuce15 = findViewById(R.id.btnLuce15);
        btnTapp7 = findViewById(R.id.btnTapp7);
        btnTapp8 = findViewById(R.id.btnTapp8);
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.btnLuce13:
                        changeState(btnLuce13.getText().toString(), "13");
                        break;
                    case R.id.btnLuce14:
                        changeState(btnLuce14.getText().toString(), "14");
                        break;
                    case R.id.btnLuce15:
                        changeState(btnLuce15.getText().toString(), "15");
                        break;
                    case R.id.btnTapp7:
                        dialogTapp("7");
                        break;
        ...
        btnLuce13.setOnClickListener(listener);
        btnLuce14.setOnClickListener(listener);
        btnLuce15.setOnClickListener(listener);
        btnTapp7.setOnClickListener(listener);
        btnTapp8.setOnClickListener(listener);
    }
                ...
                switch (Step) {
                    ...
                    case 3:
                        if (Counter < Dim-1)
                            ...
                            Counter = 0;
                            btnLuce13.setText(txtButton.get(0));
                            btnLuce14.setText(txtButton.get(1));
                            btnLuce15.setText(txtButton.get(2));
                            btnTapp7.setText(txtButton.get(3));
                            btnTapp8.setText(txtButton.get(4));
                        }
                        Step = 0;
                        break;
                }
